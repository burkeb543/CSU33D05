...
int j = 0;
char array1[] = "The length of the shortest path between";
...
void ans(){
  printf("A B C G E D F \n");
  printf("%s A and A is 0\n", array1);
  printf("%s A and B is 1\n", array1);
  printf("%s A and C is 2\n", array1);
  printf("%s A and D is 7\n", array1);
  printf("%s A and E is 5\n", array1);
  printf("%s A and F is 7\n", array1);
  printf("%s A and G is 3\n", array1);
}
...
void ch(){
  printf("J G I H F E D A B C \n");
  printf("%s J and A is 580\n", array1);
  printf("%s J and B is 590\n", array1);
  printf("%s J and C is 600\n", array1);
  printf("%s J and D is 480\n", array1);
  printf("%s J and E is 390\n", array1);
  printf("%s J and F is 360\n", array1);
  printf("%s J and G is 250\n", array1);
  printf("%s J and H is 300\n", array1);
  printf("%s J and I is 280\n", array1);
  printf("%s J and J is 0\n", array1);
}
